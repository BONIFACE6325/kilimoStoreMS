...
const translations = {
  sw: {
    ...
    logoutModalText: 'Je, una uhakika unataka kutoka kwenye mfumo wa GALANOKI? Mfumo utafunga akaunti yako kwa usalama.',
  ...
  en: {
    ...
    logoutModalText: 'Are you sure you want to log out of GALANOKI? Your active session will be securely closed.',
