...
const translations = {
  sw: {
    ...
    systemOwner: 'Mmiliki wa Mfumo',
    saasAdmin: 'Portal ya SaaS Admin',
    logoutModalTitle: 'Kutoka Mfumoni?',
    logoutModalText: 'Je, una uhakika unataka kutoka kwenye mfumo wa GARANOKI? Mfumo utafunga akaunti yako kwa usalama.',
    yesLogout: 'Ndiyo, Toka →',
    notifLoansTitle: 'Maombi 3 ya Mikopo',
    notifLoansSub: 'Yanahitaji idhini yako haraka.',
    notifPaddyTitle: 'Shehena Mpya ya Mpunga',
    notifPaddySub: 'Tani 45.2 zimepokelewa Kitalu 01.',
    overdue: 'Zilizochelewa',
    operatingExpensesShort: 'Matumizi',
    rank: 'Nafasi',
    ofRevenue: 'ya mapato',
    costCenter: 'Eneo la Gharama',
    ofExpenses: 'ya matumizi',
  ...
  en: {
    ...
    logoutModalTitle: 'Logout of System?',
    logoutModalText: 'Are you sure you want to log out of GARANOKI? Your active session will be securely closed.',
    yesLogout: 'Yes, Logout →',
    notifLoansTitle: '3 Loan Applications',
    notifLoansSub: 'Requires your quick approval.',
    notifPaddyTitle: 'New Paddy Consignment',
    notifPaddySub: '45.2 Tons received in Bin 01.',
    overdue: 'Overdue',
    operatingExpensesShort: 'Expenses',
    rank: 'Rank',
