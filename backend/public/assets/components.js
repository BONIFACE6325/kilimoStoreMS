...
const swDict = {
  ...
  'By type (Kg)': 'Kulingana na aina (Kg)',
  ...
  'Record inbound grain deliveries, check moisture levels, and issue receipts': 'Rekodi nafaka inayofika na utoe risiti ya upokeaji',
  ...
  'Unit Price (TZS/Kg) *': 'Bei ya Kipimo (Tsh/Kg) *',
  ...
  'MT received vs dispatched': 'Kilo zilizopokewa vs zilizotolewa',
  ...
  'Storage Fee per Kg per day (TZS)': 'Ada ya Uhifadhi kwa Kg kwa siku (Tsh)',
  'Drying Fee per Kg (TZS)': 'Ada ya Kukausha kwa Kg (Tsh)',
  'Milling Fee per Kg (TZS)': 'Ada ya Kusaga kwa Kg (Tsh)',
  ...
  'Moisture': 'Unyevu',
  'Variety': 'Mbegu',
  'Milled Unga (Kg)': 'Unga Uliosagwa (Kg)',
  'Grade': 'Daraja',
  'Total Due': 'Jumla ya Deni',
  'Action': 'Kitendo',
